...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Not hyperlinks")]
        [NUnit.Framework.TestCaseAttribute("http://+:80/FPSecureWebService", new string[0])]
        public virtual void NotHyperlinks(string hyperlink, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Not hyperlinks", exampleTags);
#line 52
this.ScenarioSetup(scenarioInfo);
#line 6
this.FeatureBackground();
#line 53
 testRunner.When(string.Format("I add the message \"This is not a hyperlink: {0} This is text not following a hype" +
                        "rlink\" from user \'Testuser\'", hyperlink));
#line 54
 testRunner.Then(string.Format("the message should be displayed like \"<Testuser> This is not a hyperlink: {0} Thi" +
                        "s is text not following a hyperlink\"", hyperlink));
#line 55
 testRunner.And(string.Format("\"{0}\" should not be a hyperlink", hyperlink));
#line hidden
            this.ScenarioCleanup();
        }
